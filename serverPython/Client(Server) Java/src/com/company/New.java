...
class ServerSomthing extends Thread {
    ...
    public ServerSomthing(Socket socket) throws IOException {
        ...
        New.story.printStory(out); // поток вывода передаётся для передачи истории последних 10
        ...
        try {
            ...
            try {
                while (true) {
                    ...
                    New.story.addStoryEl(word);
                    for (ServerSomthing vr : New.serverList) {
